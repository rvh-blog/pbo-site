...
export function SocialLinks() {
  return (
    <section aria-labelledby="social-links-title" className="flex flex-col items-center justify-center gap-3">
      <h2 id="social-links-title" className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--foreground-muted)]">
        Connect with PBO
      </h2>
      <div className="flex items-center justify-center gap-2">
        {socialLinks.map((social) => (
          <a
            ...
            className="flex h-11 w-11 items-center justify-center rounded-lg border border-[var(--background-tertiary)] bg-[var(--background-secondary)] text-[var(--foreground-muted)] transition-all hover:-translate-y-0.5 hover:border-[var(--primary)]/60 hover:text-white"
            title={social.label}
