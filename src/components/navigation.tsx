...
const navItems = [
  ...
  { href: "/draft-planner", label: "Planner" },
        ...
        <div className="md:hidden absolute left-0 right-0 top-full border-t border-[var(--background-tertiary)] bg-[var(--background-secondary)] shadow-xl">
          <div className="container mx-auto px-4 py-4 space-y-1">
            ...
            <Link
              href="/admin"
              onClick={() => setMobileMenuOpen(false)}
              className="block py-3 px-4 rounded-lg font-bold uppercase text-sm tracking-wide text-[var(--foreground-muted)] hover:text-white hover:bg-[var(--background-tertiary)] transition-all"
            >
