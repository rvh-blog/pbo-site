...
async function ensureShowdownLoaded(): Promise<void> {
  ...
  scriptsLoading = (async () => {
    ...
    // Nudge the turn counter slightly right for fullscreen overlay
    const turnStyle = document.createElement("style");
    turnStyle.textContent = `
      .showdown-frame .turn { margin-left: 12px; }
    `;
...
// fill the full 1920×1080 overlay (fullscreen mode).
// 640×360 × 3 = 1920×1080 — perfect fit.
const BATTLE_W = 640;
const BATTLE_H = 360;
