...
const modules = [
  ...
  { href: "/experimental-stats/compare", title: "Compare", description: "Compare two Pokémon under the exact same filters using usage, team usage, and side-by-side metric bars.", icon: GitCompareArrows, accent: "from-fuchsia-500/20 to-cyan-500/5", color: "text-fuchsia-300" },
  ...
  { href: "/experimental-stats/battle-visualizer", title: "Battle Visualizer", description: "Explore win probability, WPA key plays, clutch context, team HP, faint order, and item timing.", icon: BarChart3, accent: "from-red-500/20 to-pink-500/5", color: "text-red-300" },
