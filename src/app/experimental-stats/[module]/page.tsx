...
const moduleCopy: Record<ExperimentalModuleSlug, { title: string; description: string; clientModule: ExperimentalClientModule }> = {
  ...
  compare: { title: "Compare", description: "Place two qualified Pokémon under the same replay filters and compare their usage, team usage, and output directly.", clientModule: "compare" },
  ...
  "battle-visualizer": { title: "Battle Visualizer", description: "Explore win probability, WPA key plays, clutch context, team HP, faint timing, and item reveals for one battle.", clientModule: "visualizer" },
