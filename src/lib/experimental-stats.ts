...
export const experimentalMetricGroups: Array<{
  ...
  },
  {
    ...
    metrics: [
      ...
      partial("Move-to-KO signals", "Move names attached to saved faint events; complete causation requires normalized damage events."),
    ],
  },
  {
    ...
    metrics: [
      ...
      available("Comeback wins", "Wins where the eventual winner recorded the first faint in the saved replay timeline."),
